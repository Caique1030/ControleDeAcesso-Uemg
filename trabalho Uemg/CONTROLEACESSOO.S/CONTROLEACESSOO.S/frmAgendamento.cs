...
namespace CONTROLEACESSOO.S
{
    public partial class frmAgendamento : Form
    {
        ...
        public frmAgendamento(string opcao = "")
        {
            InitializeComponent();
            ...
            if (!Acessos.LiberadoOpcaoAdicionar("TecnicoResponsavel", usuario.MEnuAcesso)) // chamando o metodo liberado ,para a opcao do menu 
                toolStripButton1.Enabled = false;
            if (!Acessos.LiberadoOpcaoAlterar("TecnicoResponsavel", usuario.MEnuAcesso))
                toolStripButton2.Enabled = false;

            if (!Acessos.LiberadoOpcaoExcluir("TecnicoResponsavel", usuario.MEnuAcesso))
                toolStripButton3.Enabled = false;

            if (!Acessos.LiberadoOpcaoConsultar("TecnicoResponsavel", usuario.MEnuAcesso))
